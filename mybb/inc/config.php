...
$config['database']['database'] = 'REPLACE_WITH_DATABASE';
$config['database']['table_prefix'] = 'REPLACE_WITH_DB_TABLE_PREFIX';

$config['database']['hostname'] = 'REPLACE_WITH_DB_HOSTNAME';
$config['database']['username'] = 'REPLACE_WITH_DB_USER';
$config['database']['password'] = 'REPLACE_WITH_DB_PASSWORD';
